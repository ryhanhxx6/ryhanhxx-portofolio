    ...
    >
      <RevealOnScroll>
        <p className="text-md mb-8 max-w-3xl text-center text-gray-400">
          ...
          <a href="https://instagram.com/ryhanhxx"><span className="text-red-400">@ryhanhxx</span></a>, or by clicking the
          links below. For all business and projects inquiries, email me at{" "}
          <span className="text-red-400">ryhanhxx6@gmail.com</span>.
        </p>
      </RevealOnScroll>
    </section>
  );
